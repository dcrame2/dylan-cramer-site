...
export default function SocialCards({ animated = true, inView = true, delay = 0 }: SocialCardsProps) {
  return (
    <div className="grid md:grid-cols-3 gap-6">
      {platforms.map((platform, i) => {
        const content = (
          <>
            <div className={`absolute top-0 left-0 w-full h-1 bg-gradient-to-r ${platform.color} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-t-2xl`} />
