      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="/app"
              className="ml-2 px-4 py-2 bg-red-600 text-white text-xs font-bold uppercase tracking-wider rounded-full hover:bg-red-500 transition-colors"
            >
              Get InstaCal
            </a>
          </div>
          ...
          >
            ...
            >
              <a
                href="/app"
                onClick={() => setMobileOpen(false)}
                className="inline-block px-8 py-3 bg-red-600 text-white text-lg font-bold uppercase tracking-widest rounded-full hover:bg-red-500 transition-colors"
              >
                Get InstaCal
              </a>
            </motion.div>
