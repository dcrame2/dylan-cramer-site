...
export default function InstaCal() {
  ...
  return (
    <section id="instacal" ref={ref} className="relative py-32 px-6 overflow-hidden scroll-mt-24">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 relative z-10">
              <a
                ...
                className="group flex items-center gap-2 md:gap-3 px-4 py-2.5 md:px-6 md:py-3 bg-white text-black font-bold text-xs md:text-sm uppercase tracking-wider hover:bg-red-500 hover:text-white transition-all rounded-xl"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 md:gap-3 px-4 py-2.5 md:px-6 md:py-3 border border-white/20 text-white font-bold text-xs md:text-sm uppercase tracking-wider hover:border-red-500 hover:text-red-500 transition-all rounded-xl"
              >
                <svg className="w-5 h-5 md:w-6 md:h-6" fill="currentColor" viewBox="0 0 24 24">
